    ...
    var VanillaTilt = (function () {
        ...
        class VanillaTilt {
            constructor(element, settings = {}) {
                ...
                this.gyroscope = VanillaTilt.isSettingTrue(
            ...
            addEventListeners() {
                ...
                this.onDeviceOrientationBind = this.onDeviceOrientation.bind(
                    this
                );
            ...
            extendSettings(settings) {
                ...
                for (var property in defaultSettings) {
                    if (property in settings) {
                        ...
                        this.element.hasAttribute("data-tilt-" + property)
                    ) {
            ...
            static init(elements, settings) {
                ...
                elements.forEach((element) => {
                    if (!("vanillaTilt" in element)) {
                        element.vanillaTilt = new VanillaTilt(
                            element,
                            settings
                        );
                    }
